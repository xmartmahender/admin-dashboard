          ...
          {section === "stories" && (
            <Card title="Stories">
              <div className="flex flex-col space-y-2 mb-4">
                ...
                <button
                  onClick={addStory}
                  className="bg-gradient-to-r from-pink-500 to-purple-500 text-white px-5 py-2 rounded font-bold mt-2 hover:scale-105 transition"
                >Add Story</button>
              </div>
              <ul className="divide-y">
                {stories.map((story, idx) => (
                  <li key={idx} className="flex items-center justify-between py-2">
                    <a href={story.link} target="_blank" rel="noopener noreferrer" className="text-indigo-700 hover:underline font-medium">{story.title}</a>
                    <button
            ...
            <Card title="Videos">
              ...
              <ul className="divide-y">
                {videos.map((video, idx) => (
                  <li key={idx} className="flex items-center justify-between py-2">
                    <a href={video.link} target="_blank" rel="noopener noreferrer" className="text-pink-700 hover:underline font-medium">{video.title}</a>
                    <button
